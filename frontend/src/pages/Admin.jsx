      ...
      <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "3rem", paddingBottom: "2rem", borderBottom: "1px solid var(--border-color)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
          <div style={{ textAlign: "right" }}>
            <p style={{ margin: 0, fontWeight: "700", color: "var(--text-main)" }}>System Admin</p>
            <p style={{ margin: 0, fontSize: "0.9rem", color: "var(--text-muted)" }}>{currentUser?.email}</p>
          </div>
          <button onClick={logout} style={{ background: "var(--bg-surface)", border: "1px solid var(--border-color)", padding: "0.75rem 1.5rem", borderRadius: "8px", fontWeight: "700", color: "var(--danger)", cursor: "pointer", boxShadow: "var(--shadow-sm)" }}>Quit Session</button>
        </div>
      </header>
      ...
      <div style={{ display: "flex", gap: "3rem", alignItems: "flex-start" }}>
        ...
        <div style={{ width: "250px", display: "flex", flexDirection: "column", gap: "0.5rem", flexShrink: 0 }}>
          <button 
            ...
            style={{ 
              display: "flex", alignItems: "center", gap: "1rem", width: "100%", padding: "1.25rem", borderRadius: "12px", border: "none", cursor: "pointer",
